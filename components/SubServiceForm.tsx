          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-1">
              <div className="flex items-center gap-3">
                ...
                <Input id="subServiceName" className="flex-1" value={subServiceName} onChange={e => handleNameChange(e.target.value)} required />
              </div>
            ...
            <div className="space-y-1">
              <div className="flex items-center gap-3">
                ...
                <Input id="slug" className="flex-1" value={slug} onChange={e => setSlug(e.target.value)} required />
              </div>
            ...
            <div className="space-y-1 md:col-span-2">
              <div className="flex items-center gap-3">
                ...
                <Input id="moto" className="flex-1" value={moto} onChange={e => setMoto(e.target.value)} />
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-1">
              <div className="flex items-start gap-3">
                ...
                <Textarea id="definition" className="flex-1" value={definition} onChange={e => setDefinition(e.target.value)} required />
              </div>
            ...
            <div className="space-y-1">
              <div className="flex items-start gap-3">
                ...
                <Textarea id="commitment" className="flex-1" value={commitment} onChange={e => setCommitment(e.target.value)} required />
              </div>
          ...
          <div className="space-y-4">
            <div className="space-y-1">
              <div className="flex items-start gap-3">
                ...
                <Textarea id="organizationalDefinition" className="flex-1" value={organizationalDefinition} onChange={e => setOrganizationalDefinition(e.target.value)} required />
              </div>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Button type="button" variant="outline" size="sm" onClick={() => setNeeds(prev => [...prev, { title: "", description: "" }])}>Add Need</Button>
              </div>
              {needs.map((n, idx) => (
                <div key={idx} className="grid grid-cols-1 md:grid-cols-2 gap-2">
                  <Input placeholder="Title" value={n.title} onChange={e => setNeeds(prev => prev.map((p,i)=> i===idx? { ...p, title: e.target.value }: p))} />
                  <Input placeholder="Description" value={n.description} onChange={e => setNeeds(prev => prev.map((p,i)=> i===idx? { ...p, description: e.target.value }: p))} />
                  <div className="md:col-span-2 flex justify-end">
                    <Button type="button" variant="ghost" onClick={() => setNeeds(prev => prev.filter((_,i)=> i!==idx))}>Remove</Button>
                  </div>
                </div>
              ))}
          ...
          <div className="space-y-4">
            <div className="space-y-1">
              <div className="flex items-start gap-3">
                ...
                <Textarea id="businessValueDefinition" className="flex-1" value={businessValueDefinition} onChange={e => setBusinessValueDefinition(e.target.value)} required />
              </div>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Button type="button" variant="outline" size="sm" onClick={() => setValues(prev => [...prev, { title: "", description: "" }])}>Add Value</Button>
              </div>
              {values.map((v, idx) => (
                <div key={idx} className="grid grid-cols-1 md:grid-cols-2 gap-2">
                  <Input placeholder="Title" value={v.title} onChange={e => setValues(prev => prev.map((p,i)=> i===idx? { ...p, title: e.target.value }: p))} />
                  <Input placeholder="Description" value={v.description} onChange={e => setValues(prev => prev.map((p,i)=> i===idx? { ...p, description: e.target.value }: p))} />
                  <div className="md:col-span-2 flex justify-end">
                    <Button type="button" variant="ghost" onClick={() => setValues(prev => prev.filter((_,i)=> i!==idx))}>Remove</Button>
                  </div>
                </div>
              ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-1">
              <div className="flex items-center gap-3">
                ...
                <Input id="ctaTitle" className="flex-1" value={ctaTitle} onChange={e => setCtaTitle(e.target.value)} required />
              </div>
            ...
            <div className="space-y-1">
              <div className="flex items-start gap-3">
                ...
                <Textarea id="ctaDescription" className="flex-1" value={ctaDescription} onChange={e => setCtaDescription(e.target.value)} required />
              </div>
